import 'dart:core';
import 'dart:async';
import 'package:alarm_clock_app/splash_screen.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      title: 'Alarm Clock',
      theme: ThemeData(
        primaryColor: const Color(0xff052c7c),
        useMaterial3: true,
      ),
      home: SplashScreen(),
  ...
  void _showAlarmTimeToast() async {
    if (_alarmEnabled) {
      ...
      Fluttertoast.showToast(
        ...
        backgroundColor: const Color(0xff052c7c),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        backgroundColor: Color(0xff052c7c),
        centerTitle: true,
      ),
      body: Padding(
          ...
          children: [
            ...
            ElevatedButton(
              ...
              style: ElevatedButton.styleFrom(
                backgroundColor: Color(0xff052c7c), // Set the button color here
              ),
